...
Matter.Body.applyForce(bobObject1.body , bpbObject1.body.position , {x: -50 , y: -45});
...
function drawline(Constraint){
	...
	roofBodyPosition=Constraint.bodyB.roofBodyPosition

	roofBodyOffset=Constraint.bodyA
